...
ActiveRecord::Schema[7.1].define(version: 2025_04_15_044249) do
  ...
  create_table "dbtools$execution_history", force: :cascade do |t|
    t.text "hash"
    t.string "created_by"
  ...
  create_table "report", primary_key: "reportid", force: :cascade do |t|
  ...
  create_table "users", primary_key: "userid", default: "0.0", force: :cascade do |t|
